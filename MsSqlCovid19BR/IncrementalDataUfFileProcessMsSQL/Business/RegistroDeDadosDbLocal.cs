...
using System.IO;
using IncrementalDataUfFileProcessMsSQL.Controller;
using LibConsoleProgressBar;
using IncrementalDataUfFileProcessMsSQL.Model;
using LibToolsLog;
using System.Threading.Tasks;
using System.Threading;

namespace IncrementalDataUfFileProcessMsSQL.Business
{
    public class RegistroDeDadosDbLocal : IDisposable
    {
        ...
        public RegistroDeDadosDbLocal(string incrementalUF, string incrementalData)
        {

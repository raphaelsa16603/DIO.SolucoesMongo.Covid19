...
using LibFileTools;
using LibWeb;
using GerarScriptMsSqlINSERT.Business;
using System;
using System.Configuration;
using System.IO;
using System.Threading;

namespace GerarScriptMsSqlINSERT
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var ForDb = new RegistroDeDadosDbLocal())
            {
                ...
                System.Console.WriteLine(" Gerando Scrip de INSERT para o Banco de Dados MicrosoftSQL ");
                System.Console.WriteLine("------------------------------------------------------------");

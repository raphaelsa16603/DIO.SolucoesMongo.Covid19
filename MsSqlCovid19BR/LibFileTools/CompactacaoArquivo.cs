   ...
   public class CompactacaoArquivo
    {
            ...
            public static void Compress(string directoryPath)
            {
                ...
                try {
                    ...
                    Console.WriteLine(
                    $"Não foi possível compactar o diretório: {directorySelected.Name} -> {ex.Message} => {ex.StackTrace}");
                }
            }
            ...
            public static void Decompress(string pathFileGz)
            {
                ...
                try {
                    ...
                    Console.WriteLine(
                        $"Não foi possível descompactar o arquivo: {fileToDecompress.Name} -> {ex.Message} => {ex.StackTrace}");
                }
            }
    }

...
using System.IO;
using MongoDbAtlasUfFileProcess.Controller;
using MongoDbAtlasUfFileProcess.Model;
using LibConsoleProgressBar;
using LibToolsLog;

namespace MongoDbAtlasUfFileProcess.Business
{
    public class RegistroDeDadosDbLocal : IDisposable
    {
        ...
        public RegistroDeDadosDbLocal(Data.MongoDB mongoDB, string incrementalUF)
        {
